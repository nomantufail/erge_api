            ...
            <div style="display: table-cell; height: 100%;">
                <div style="padding: 25px;">
                    ...
                    <p style="color: #2a2a2a; font-size: 14px;">
                        We have received Funds Withdrawal request of <strong><?php echo $requested_amount."$"; ?></strong> on <strong><?php 
                        $amNY = new \DateTime('America/New_York');
                        $estTime = $amNY->format('d - F - Y h:iA T');
                        echo $estTime;
                        
                        ?></strong>. <br>
                        Your payment will be processed and credited to your provided PayPal email address : <strong><?php echo $paypal_email; ?></strong> within a week. 
                    </p>
                </div>
                <div style="padding: 25px;">
